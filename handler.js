...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Perintah ini hanya dapat digunakan oleh _*Solomon*_',
    owner: 'Perintah ini hanya dapat digunakan oleh _*Solomon*_',
    mods: 'Perintah ini hanya dapat digunakan oleh _*Admin Vestia*_',
    premium: 'Perintah ini hanya untuk pengguna _*Premium*_',
    group: 'Perintah ini hanya dapat digunakan di grup',
    private: 'Perintah ini hanya dapat digunakan di Chat Pribadi',
    admin: 'Perintah ini hanya untuk *Admin* grup',
    botAdmin: 'Jadikan bot sebagai *Admin* untuk menggunakan perintah ini',
    unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*.daftar nama.umur*\n\nContoh: *.daftar Solomon.16*',
